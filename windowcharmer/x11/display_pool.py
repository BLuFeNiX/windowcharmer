...
class DisplayPool:
    """Manages named Display connections, one per role (wm, mapper, input).

    The pool provides role-based, not thread-based, separation. Most roles are
    used from a single thread (wm: main, input: main), but a connection may be
